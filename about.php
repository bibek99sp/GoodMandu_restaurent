			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>GoodMandu resturent</span></h1>
						<h4>Little Story</h4>
						<p> 
						<p class="text-bold">Goodmandu was a small restaurant located in the bustling streets of Paknajol, Kathmandu. Despite its unassuming appearance, the restaurant was a hidden gem known for its delicious Nepalese dumplings, or momos as they were commonly called. </p>
				...
				<div class="col-md-12">
					<div class="inner-pt">
						<p> Goodmandu was a small restaurant located in the bustling streets of Paknajol, Kathmandu. Despite its unassuming appearance, the restaurant was a hidden gem known for its delicious Nepalese dumplings, or momos as they were commonly called. 

 </p>
						<p>Today, Goodmandu remains a testament to the power of good food and warm hospitality. It is a place where people from all walks of life can come together and share a love for delicious Nepalese food.
 </p>
					</div>
				</div>
			</div>
