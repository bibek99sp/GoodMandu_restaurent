...
$result = mysqli_query($con, "SELECT * FROM product_ratings_view_no_book_name");
...
$userNames = array();
$result = mysqli_query($con, "SELECT id FROM registration");
$result_book = mysqli_query($con, "SELECT title FROM menu");
...
$sql = "CREATE TABLE final_array_view (id INT AUTO_INCREMENT PRIMARY KEY, BOOK VARCHAR(255), " . implode(", ", $columnNames) . ")AUTO_INCREMENT=35";
